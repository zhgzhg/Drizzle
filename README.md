 ...
 *
 * @ArduinoTool Drizzle::(<0.16.6)::https://github.com/zhgzhg/Drizzle/releases/download/0.16.6/drizzle-0.16.6-dist.zip
 */
...
For e.g. `java -jar drizzle-0.16.6-with-deps.jar --parse hello-world.ino` will produce:
...
```
{
  ...
  "arduino_ide_tools": {
    "Drizzle": {
      "version": "(<0.16.6)",
      "url": "https://github.com/zhgzhg/Drizzle/releases/download/0.16.6/drizzle-0.16.6-dist.zip"
    }
  }
}
```

Executing on the above JSON `java -jar drizzle-0.16.6-with-deps.jar --rev-parse hello-world.json` will produce:
