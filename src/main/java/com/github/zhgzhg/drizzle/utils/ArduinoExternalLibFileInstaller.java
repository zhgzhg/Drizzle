...
public class ArduinoExternalLibFileInstaller {
    private LogProxy logProxy;

    public ArduinoExternalLibFileInstaller(LogProxy logProxy) {
    ...
    public void logSuccessfullyInstalledLib(File source) {
        this.logProxy.cliInfo("Successfully added library '%s'!%n", source.toString());
    }
}
