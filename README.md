 ...
 *
 * @ArduinoTool Drizzle::(<0.11.4)::https://github.com/zhgzhg/Drizzle/releases/download/0.11.4/drizzle-0.11.4-dist.zip
 */
...
For e.g. `java -jar drizzle-0.11.4.jar --parse hello-world.ino` will produce:
...
```
{
  ...
  "arduino_ide_tools": {
    "Drizzle": {
      "version": "(<0.11.4)",
      "url": "https://github.com/zhgzhg/Drizzle/releases/download/0.11.4/drizzle-0.11.4-dist.zip"
    }
  }
}
```

Executing on the above JSON `java -jar drizzle-0.11.4.jar --rev-parse hello-world.json` will produce:
