 ...
 *
 * @ArduinoTool Drizzle::(<0.12.1)::https://github.com/zhgzhg/Drizzle/releases/download/0.12.1/drizzle-0.12.1-dist.zip
 */
...
For e.g. `java -jar drizzle-0.12.1.jar --parse hello-world.ino` will produce:
...
```
{
  ...
  "arduino_ide_tools": {
    "Drizzle": {
      "version": "(<0.12.1)",
      "url": "https://github.com/zhgzhg/Drizzle/releases/download/0.12.1/drizzle-0.12.1-dist.zip"
    }
  }
}
```

Executing on the above JSON `java -jar drizzle-0.12.1.jar --rev-parse hello-world.json` will produce:
